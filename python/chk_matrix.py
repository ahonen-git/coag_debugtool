...
cn5 = ax5.pcolormesh(X,Y,z_brown_b25, vmin=-10.0,vmax=10.0, cmap='RdBu')
...
dn5 = bx5.pcolormesh(X,Y,z_shear_b25, vmin=-10.0,vmax=10.0, cmap='RdBu')
...
en5 = cx5.pcolormesh(X,Y,z_ds_b25, vmin=-10.0,vmax=10.0, cmap='RdBu')
